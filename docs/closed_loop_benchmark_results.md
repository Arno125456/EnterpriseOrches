...
|---|---|---|---|---|
| **Static (Open-Loop)** | 0.560 ± 0.050 | **Breached (-0.408)** | $400.0 | Reference Baseline |
| **CapOrches Adaptive** | 0.995 ± 0.006 | **Preserved (0.938)** | $1040.0 | **+0.434 [0.410, 0.458]** |
| **CapOrches + UCB (F25)** | 0.801 ± 0.038 | **Preserved (0.938)** | $1024.0 | **+0.240 [0.212, 0.268]** |

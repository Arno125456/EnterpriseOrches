...
| document | use it when |
|---|---|
| [`poc_findings.md`](poc_findings.md) | The full chronological log, 33 findings **including superseded ones**. Do not quote from it without checking the summary's corrections table |

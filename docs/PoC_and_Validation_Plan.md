...
|---|---|
| §3.1.7 Track A | Provisional — T2 and T4 may change or remove sub-modules |
| §3.1.7 Track B | Provisional — T1 may change the decomposition axis or invalidate the track |
| §3.1.7 Track C | Stable — least affected |
